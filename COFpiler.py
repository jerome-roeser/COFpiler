...
parser.add_argument("--data", type=str, default="data_example.xlsx", help="The input file include data needed, form as: form as: the 1st column "
...
parser.add_argument("--instr", type=str, default= "COF-1.cif", help="The input structure")
parser.add_argument("--tem", type=int, default=293, help="The experimental synthesize temperature")
parser.add_argument("--path", type=str, default="C:/temp/git_repos/COFpiler/data/", help="The path where the infile and instr are, the output structure will also "
                                             "save there")
...
parser.add_argument("--L", type=int, default= 10, help="the layer number")
parser.add_argument("--M", type=int, default=10, help="the model number")
